...
const factsDatabase = [
    {
        id: 1,
        title: "Девушка Домера",
        content: "А вы знали, что девушку Домера (Сергея Камышникова) зовут Алина, также известная как Alino4kaPrincess? Она является главным героем каналов Domer Grief и Огород Домера, а в скором времени у них с Сергеем планируется свадьба!",
        category: "Ютуберы",
        source: "Хранилище"
    },
    {
        id: 2,
        title: "Мат или Сленг?",
        content: "А вы знали, что слово «хули» — это сленг, а не мат? Сленг отличается от нецензурной лексики и жаргона, являясь просто разговорной формой языка без оскорбительного подтекста.",
        category: "Лингвистика",
        source: "Хранилище"
    },
    {
        id: 3,
        title: "Ошибки в переговорах о пиаре",
        content: "А вы знали, что при переговорах о пиаре существуют три главные анти-ошибки: неадекватная оценка стоимости услуг («пиар за 15 звезд»), попытка получить админку в канале (нарушение безопасности) и написание поста самим заказчиком (непрофессиональный подход)? Правильный подход — это чёткое ТЗ, бюджет и уважение правил площадки!",
        category: "Маркетинг",
        source: "Хранилище"
    },
    {
        ...
        content: "А вы знали, что мессенджер Max от VK запрашивает широкие системные разрешения, передаёт данные на серверы VK, не имеет шифрования переписки и звонков, а также отказывается запускаться на Android 9? Многие специалисты считают, что он ведёт себя скорее как шпионская программа, чем как безопасный мессенджер.",
        category: "Технологии",
        source: "Хранилище"
    },
    {
        id: 5,
        title: "Недрочабрь",
        content: "А вы знали, что существует интернет-челлендж «Недрочабрь», участники которого воздерживаются от мастурбации в течение всего ноября? Это челлендж на силу воли, который набирает популярность в сети.",
        category: "Интернет-культура",
        source: "Хранилище"
    },
    {
        id: 6,
        title: "ИТД — новая платформа",
        content: "А вы знали, что 16 декабря 2025 года блогер Новка запустил новую гибридную платформу «ИТД» — смесь соцсети и форума с системой кланов (например, ❤️‍🔥), которую нельзя изменить после регистрации? Платформа быстро развивается: уже добавлены верификация, тёмная тема и сезонный декор.",
        category: "Соцсети",
        source: "Хранилище"
    },
    {
        id: 7,
        title: "Трендовые запросы Google",
        content: "А вы знали, что в топ поисковых запросов Google в конце 2025 года входили: «Майнкрафт 26.1», «Telegram проблемы со звонками», «FaceTime не работает», «Мессенджер Max что это», «Snapchat заблокирован», а также вечные лидеры — «погода завтра», «новый год 2026 выходные» и «курс валют»?",
        category: "Интернет",
        source: "Хранилище"
    },
    {
        id: 8,
        title: "Язык Сибилевец",
        content: "А вы знали, что существует искусственный язык «Сибилевец», созданный Тимофеем Сибилевым для лёгкого международного общения? Он сочетает простоту изучения с богатыми выразительными возможностями. Подана петиция на добавление этого языка в Duolingo!",
        category: "Лингвистика",
        source: "Хранилище"
    },
    {
        id: 9,
        title: "Just Monika",
        content: "А вы знали, что Monika из игры Doki Doki Literature Club — персонаж, который осознаёт, что находится в игре, и начинает напрямую общаться с игроком через экран? Её фраза «Just Monika» стала интернет-мемом и символом игры.",
        category: "Игры",
        source: "Хранилище"
    },
    {
        id: 10,
        title: "Тайвань",
        content: "А вы знали, что согласно статье из Хранилища, Тайвань является независимым государством и не принадлежит Китаю? Этот вопрос остаётся предметом международных споров.",
        category: "Политика",
        source: "Хранилище"
    },
    {
        id: 11,
        title: "Белойн — цифровой детокс",
        content: "А вы знали, что существует движение «Белойн», призывающее к осознанному отключению от цифрового шума? Они организуют пространства тишины для медитации, тактильные карты ручной работы, эпистолярный клуб с каллиграфией и природные ретриты. Их философия: «Осознанность вместо скроллинга, живые диалоги вместо чатов».",
        category: "Психология",
        source: "Хранилище"
    }
];
